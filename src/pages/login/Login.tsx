        ...
        <>
            <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold ">
                ...
                >
                    ...
                    <button
                        type="button"
                        onClick={loginConvidado}
                        className="rounded bg-slate-500 flex justify-center
                                   hover:bg-slate-800 text-white w-1/2 py-2">
                        {isLoading ? <ClipLoader color="#ffffff" size={24} /> : <span>Acesso Visitante</span>}
                    </button>
